...
// Forward-declare the missing controllers/functions needed for the buttons
// As a real-world solution, these imports should resolve the missing pieces.
// For this answer, I will assume they are available in the imports.
// class DrawerControllerX extends GetxController { void goBack() {} }
// class MainController extends GetxController { void alertPage() {} }
// Widget buildCircularIconButton({required BuildContext context, required IconData icon, required VoidCallback onPressed}) { return Container(); }
// Widget buildMainButton({required String text, required VoidCallback onPressed, required BuildContext context}) { return Container(); }
...
class _PrivacypolicyState extends State<Privacypolicy> {
  ...
  Widget build(BuildContext context) {
    ...
    // Initialize GetX controllers as in the reference code
    // Assuming DrawerControllerX is already initialized elsewhere with Get.find
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: TextStyle(
              ...
              color: dark
                  ? Colors.white
                  : Colors.black, // Apply dark mode color
            ),
          ),
          leading: Builder(
